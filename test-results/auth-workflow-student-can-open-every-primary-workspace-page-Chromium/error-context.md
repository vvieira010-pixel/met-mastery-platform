...
Expected substring: "MET skills"
Received string:    "Skip to practice contentPRACTICE STUDIOPractice that fits your shift, not the other way aroundOne calm rep at a time — pick a skill, pick a topic, do one question. No catalogue fatigue.Start Today's SetBrowse LibrarySix skills, zero clutter218 Grammar · 128 Vocab · 102 Reading · 179 Speaking prompts · 138 Writing · 63 Listening clipsGrammar SprintTenses to inversion — 21 topics→Vocab Deep-DiveWork to media — 11 topics→Reading Lab51 passages · 102 questions→Speaking MirrorFive MET question formats · topic paths→Writing StudioShort answer to essay — 138 tasks→Listening LabMET-style drills — 63 clips→Loading…"

Call log:
  - Expect "toContainText" with timeout 20000ms
  - waiting for locator('.dash-body, main').first()
    5 × locator resolved to <main class="dash-body" id="student-content" aria-label="Subjects content">…</main>
      - unexpected value "Skip to practice contentPRACTICE STUDIOPractice that fits your shift, not the other way aroundOne calm rep at a time — pick a skill, pick a topic, do one question. No catalogue fatigue.Start Today's SetBrowse LibrarySix skills, zero clutter218 Grammar · 128 Vocab · 102 Reading · 179 Speaking prompts · 138 Writing · 63 Listening clipsGrammar SprintTenses to inversion — 21 topics→Vocab Deep-DiveWork to media — 11 topics→Reading Lab51 passages · 102 questions→Speaking MirrorFive MET question formats · topic paths→Writing StudioShort answer to essay — 138 tasks→Listening LabMET-style drills — 63 clips→Loading…"
  - Test timeout of 30000ms exceeded.

```

```yaml
- main "Subjects content": Loading…
```
