export default {
  ...
  "passages": [
      ...
      "questions": [
        {
          ...
          "correct": "A",
          "explanation": "The passage traces fairs from the 1800s (displaying inventions) to the 1900s (addressing global issues) to today (still showcasing the future)."
        },
        {
          "number": 2,
          "type": "detail",
          "question": "According to the passage, what was the main purpose of early world's fairs?",
          "options": {
          ...
          "correct": "B",
          "explanation": "Paragraph 2 says early fairs exposed audiences to 'the latest ideas' and served as 'educational forums'"
        },
        {
          "number": 3,
          "type": "vocabulary",
          "question": "In the second sentence of paragraph 2, what does the phrase 'reminiscent of' mean?",
          "options": {
            "A": "similar to",
            "B": "located near",
            "C": "designed by",
          ...
          "correct": "A",
          "explanation": "Reminiscent means similar to."
        },
        {
          "number": 4,
          "type": "purpose",
          "question": "Why does the author mention Expo 67 in Montreal?",
          "options": {
          ...
          "correct": "A",
          "explanation": "Expo 67 illustrates the shift to addressing global issues."
        },
        {
          "number": 5,
          "type": "inference",
          "question": "What does the author suggest about future world's fairs?",
          "options": {
          ...
          "correct": "B",
          "explanation": "Internet hasn't removed desire to see future with own eyes."
        }
      ]
    },
    {
      ...
      "questions": [
        ...
        },
        {
          "number": 7,
          "type": "detail",
          "question": "According to the passage, how is the Great Red Spot different from hurricanes on Earth?",
          "options": {
        ...
        },
        {
          "number": 8,
          "type": "vocabulary",
          "question": "In the fourth sentence of paragraph 3, which word is closest in meaning to 'concede'?",
          "options": {
            "A": "admit",
            "B": "prove",
            "C": "wonder",
        ...
        },
        {
          "number": 9,
          "type": "purpose",
          "question": "Why does the author mention the storm's changing shape?",
          "options": {
        ...
        },
        {
          "number": 10,
          "type": "inference",
          "question": "What is the author's opinion about the future of the Great Red Spot?",
          "options": {
    ...
    },
    {
      ...
      "questions": [
        ...
        },
        {
          "number": 12,
          "type": "detail",
          "question": "According to the passage, what effect does fast music have on customers in a store?",
          "options": {
        ...
        },
        {
          "number": 13,
          "type": "vocabulary",
          "question": "In the second sentence of paragraph 2, which word is closest in meaning to 'identified'?",
          "options": {
            "A": "recognized",
            "B": "created",
            "C": "ignored",
        ...
        },
        {
          "number": 14,
          "type": "purpose",
          "question": "Why does the author mention customers 'on hold'?",
          "options": {
        ...
        },
        {
          "number": 15,
          "type": "inference",
          "question": "What do store owners do with Kellaris's findings?",
          "options": {
    ...
    },
    {
      "passageId": 4,
      "kind": "single",
      "topic": "Grandville Music Center",
      "intro": "This passage is about a music school.",
      ...
      "questions": [
        {
          ...
          "question": "The following question refers to section A. What can be inferred about the guitar teachers?",
          "options": {
        ...
        },
        {
          "number": 17,
          "type": "detail (section A)",
          "question": "The following question refers to section A. What should someone do who wants to take guitar lessons?",
          "options": {
        ...
        },
        {
          ...
          "question": "The following question refers to section B. Why did piano students do well on a fractions test?",
          "options": {
        ...
        {
          "number": 19,
          "type": "purpose (section B)",
          "question": "The following question refers to section B. How does the author feel about musical education?",
          "options": {
        ...
        },
        {
          "number": 20,
          "type": "detail (section B)",
          "question": "The following question refers to section B. According to the passage, what is the main benefit of music for children?",
          "options": {
    ...
    },
    {
      ...
      "questions": [
        ...
        },
        {
          "number": 22,
          "type": "detail",
          "question": "According to the passage, how was chocolate originally used?",
          "options": {
        ...
        },
        {
          "number": 23,
          "type": "vocabulary",
          "question": "In the third sentence of paragraph 2, which word is closest in meaning to 'transformed'?",
          "options": {
            "A": "changed",
            "B": "hidden",
            "C": "destroyed",
        ...
        },
        {
          "number": 24,
          "type": "purpose",
          "question": "Why does the author mention 'fair trade' labels?",
          "options": {
        ...
        },
        {
          "number": 25,
          "type": "inference",
          "question": "What does the author suggest consumers should do?",
          "options": {
    ...
    },
    {
      ...
      "questions": [
        ...
        },
        {
          "number": 27,
          "type": "detail",
          "question": "According to the passage, what was one result of the printing press?",
          "options": {
        ...
        },
        {
          "number": 28,
          "type": "vocabulary",
          "question": "In the second sentence of paragraph 3, which word is closest in meaning to 'weakened'?",
          "options": {
        ...
        },
        {
          "number": 29,
          "type": "purpose",
          "question": "Why does the author mention the internet?",
          "options": {
        ...
        },
        {
          "number": 30,
          "type": "inference",
          "question": "What does the author believe about accessible information?",
          "options": {
    ...
    },
    {
      ...
      "questions": [
        ...
        },
        {
          "number": 32,
          "type": "detail",
          "question": "According to the passage, what happens when water vapor cools?",
          "options": {
        ...
        },
        {
          "number": 33,
          "type": "vocabulary",
          "question": "In the second sentence of paragraph 3, which word is closest in meaning to 'distributes'?",
          "options": {
            "A": "spreads",
            "B": "stores",
            "C": "purifies",
        ...
        },
        {
          "number": 34,
          "type": "purpose",
          "question": "Why does the author mention deforestation?",
          "options": {
        ...
        },
        {
          "number": 35,
          "type": "inference",
          "question": "What does the author suggest about the future of the water cycle?",
          "options": {
    ...
    },
    {
      ...
      "questions": [
        ...
        },
        {
          "number": 37,
          "type": "detail",
          "question": "According to the passage, why did Marie Curie move to Paris?",
          "options": {
        ...
        },
        {
          "number": 38,
          "type": "vocabulary",
          "question": "In the second sentence of paragraph 2, which word is closest in meaning to 'coined'?",
          "options": {
            "A": "invented",
            "B": "borrowed",
            "C": "translated",
        ...
        },
        {
          "number": 39,
          "type": "purpose",
          "question": "Why does the author mention the mobile X-ray units?",
          "options": {
        ...
        },
        {
          "number": 40,
          "type": "inference",
          "question": "What does the author suggest about Curie's death?",
          "options": {
    ...
    },
    {
      ...
      "intro": "This passage is about the Great Barrier Reef.",
      ...
      "questions": [
        ...
        },
        {
          "number": 42,
          "type": "detail",
          "question": "According to the passage, what role do zooxanthellae play?",
          "options": {
        ...
        },
        {
          "number": 43,
          "type": "vocabulary",
          "question": "In the third sentence of paragraph 3, which word is closest in meaning to 'expel'?",
          "options": {
            "A": "absorb",
            "B": "release",
            "C": "consume",
        ...
        },
        {
          "number": 44,
          "type": "purpose",
          "question": "Why does the author mention agricultural runoff?",
          "options": {
        ...
        },
        {
          "number": 45,
          "type": "inference",
          "question": "What do scientists believe is necessary to save the reef?",
          "options": {
    ...
    },
    {
      ...
      "questions": [
        ...
        },
        {
          "number": 47,
          "type": "detail",
          "question": "According to the passage, what did merchants do to reduce risks on the Silk Road?",
          "options": {
        ...
        },
        {
          "number": 48,
          "type": "vocabulary",
          "question": "In the first sentence of paragraph 3, which word is closest in meaning to 'facilitated'?",
          "options": {
            "A": "prevented",
            "B": "enabled",
            "C": "delayed",
        ...
        },
        {
          "number": 49,
          "type": "purpose",
          "question": "Why does the author mention Buddhism and Islam?",
          "options": {
        ...
        },
        {
          "number": 50,
          "type": "inference",
          "question": "What does the author suggest about the Silk Road's legacy?",
          "options": {
    ...
    },
    {
      ...
      "questions": [
        ...
        },
        {
          "number": 52,
          "type": "detail",
          "question": "According to the passage, what does the cerebellum do?",
          "options": {
            "A": "It forms memories.",
        ...
        },
        {
          "number": 53,
          "type": "vocabulary",
          "question": "In the third sentence of paragraph 3, which word is closest in meaning to 'phenomenon'?",
          "options": {
            "A": "problem",
            "B": "occurrence",
            "C": "theory",
        ...
        },
        {
          "number": 54,
          "type": "purpose",
          "question": "Why does the author mention neuroplasticity?",
          "options": {
        ...
        },
        {
          "number": 55,
          "type": "inference",
          "question": "What do scientists hope to achieve with better imaging technology?",
          "options": {
    ...
    },
    {
      ...
      "questions": [
        ...
        },
        {
          "number": 57,
          "type": "detail",
          "question": "According to the passage, what is a limitation of solar power?",
          "options": {
        ...
        },
        {
          "number": 58,
          "type": "vocabulary",
          "question": "In the second sentence of paragraph 1, which word is closest in meaning to 'replenished'?",
          "options": {
            "A": "replaced",
            "B": "reduced",
            "C": "measured",
        ...
        },
        {
          "number": 59,
          "type": "purpose",
          "question": "Why does the author mention large dams?",
          "options": {
        ...
        },
        {
          "number": 60,
          "type": "inference",
          "question": "What do experts believe about the future of energy?",
          "options": {
    ...
    },
    {
      ...
      "questions": [
        ...
        },
        {
          "number": 62,
          "type": "detail",
          "question": "According to the passage, who could compete in the ancient Olympics?",
          "options": {
        ...
        },
        {
          "number": 63,
          "type": "vocabulary",
          "question": "In the second sentence of paragraph 2, which word is closest in meaning to 'suppress'?",
          "options": {
            "A": "encourage",
            "B": "eliminate",
            "C": "celebrate",
        ...
        },
        {
          "number": 64,
          "type": "purpose",
          "question": "Why does the author mention the five interlocking rings?",
          "options": {
        ...
        },
        {
          "number": 65,
          "type": "inference",
          "question": "What does the author suggest about the future of the Olympics?",
          "options": {
