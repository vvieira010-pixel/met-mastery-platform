...
export default function ClassRecord({ classEventId, students, onNavigate, "data-testid": testId }) {
  ...
  if (!event) return <div className="p-5 text-muted" data-testid={testId}>Class not found.</div>;
