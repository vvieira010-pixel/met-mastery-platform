...
const STAGE_CONFIG = {
  ...
  'feedback-sent':     { label: 'Feedback sent',     tone: 'info',    action: 'Assign exercise',   getNav: (s) => ['homework:create', { studentId: s.id, diagnosisId: s.cycle.latestDiagnosis?.id }] },
  'homework-assigned': { label: 'Exercise assigned', tone: 'warning', action: 'View exercise',     getNav: ()  => ['homework', {}] },
...
export default function TeacherDashboard({ students, onNavigate, teacherName = 'Vini', 'data-testid': testId }) {
  ...
  return (
    <div className="td-shell bg-grain" data-testid={testId}>
      {/* Header */}
      ...
      <Reveal className="td-dashboard-header mb-4" y={18} blur={8}>
        ...
        {/* KPIs */}
        <div className="td-kpi-grid td-overview-grid" aria-label="Today at a glance">
          {[
       ...
       <div className="teacher-dashboard-stack">
          ...
          <Card className="td-card-section td-card-accent td-admin-actions td-quick-actions td-anim td-anim-up" bezel>
            ...
            <div className="grid-square">
              ...
              <QuickAction icon={<Icon.homework size={24} />} label="Create an exercise" onClick={() => onNavigate('homework')} />
         ...
         />
          ...
          {/* Today's classes */}
          <Card className="td-card-section td-card-accent td-class-section td-anim td-anim-up" bezel>
         ...
         {needsAttention.length > 0 && (
          ...
          {/* Student cycle board */}
          <Card className="td-card-section td-card-accent td-cycle-section td-anim td-anim-up" bezel>
            <div className="td-cycle-toolbar flex-wrap-row-3 items-center mb-2">
