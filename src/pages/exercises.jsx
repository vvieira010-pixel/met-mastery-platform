...
function GroupHeader({ label, count, 'data-testid': testId }) {
  return (
    <div className="group-header" data-testid={testId}>
...
export default function ExercisesPage({ onNavigate, 'data-testid': testId }) {
