  ...
  return (
    <div>
            ...
            {line.map((seg, j) => (
              <span
                ...
                style={seg.highlight ? {
                  ...
                  borderBottom: `2px solid ${seg.highlight === 'good' ? 'var(--success)' : 'var(--warning)'}`,
                  padding: '0 4px',
                } : {}}
                title={seg.tip}
              >
      ...
      <div className="flex gap-4 mt-3" style={{ fontSize: 'var(--text-xs)', color: 'var(--text-muted)' }}>
        <div className="flex items-center gap-1"><div className="w-2 h-2 rounded-full" style={{ background: 'var(--success)' }} /> Excellent</div>
        <div className="flex items-center gap-1"><div className="w-2 h-2 rounded-full" style={{ background: 'var(--warning)' }} /> Needs Vocab Upgrade</div>
      </div>
    </div>
  );
}
