...
export default function LandingComplete({ onMemberSignIn, "data-testid": testId }) {
  ...
  return <div className="landing-preview" data-testid={testId}>
    ...
    <header className="site-header">
      ...
      <button className="signin-link" type="button" onClick={onMemberSignIn}>Sign in</button><button className="demo-link" type="button" onClick={onMemberSignIn}>Sign in to explore</button><a className="header-cta" href="#start">Find my starting point <span aria-hidden="true">→</span></a>
    </header>
    <main id="main">
