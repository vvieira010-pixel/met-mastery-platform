...
export default function LandingComplete({ onMemberSignIn, "data-testid": testId }) {
  ...
  return <div className="landing-preview" data-testid={testId}>
    ...
    <section className="hero" id="top">
      ...
      <div className="hero-dashboard" role="img" aria-label="Illustrative diagnostic dashboard preview"><p>YOUR CURRENT PLAN <span>In progress</span></p><h2>Week 2 · Keep building</h2><div className="hero-level"><strong>B2</strong><div><b>Current CEFR level</b><small>Based on initial diagnostic · 15 May</small></div><em className="hero-score">Predicted: 81/100</em></div><div className="hero-skill-list">{skills.slice(0, 4).map(([name, score]) => <div className="hero-skill" key={name}><span>{name}</span><i><b style={{width: score}} /></i><em>{score}</em></div>)}</div><small className="hero-next">Next up: <strong>Writing: distinguishing main ideas</strong> <span>(Est. 20 min)</span></small></div>
    </section>
    ...
    <section className="educator-section" aria-labelledby="educator-title"><div className="educator-profile"><img src="/images/vinicius-vieira.png" alt="Vinicius Vieira" /><strong>Vinicius Vieira</strong><span>MET Tutor</span><div className="educator-credentials"><span>C2 CEFR Certified</span><span>Cambridge TKT</span></div></div><div><p className="eyebrow">ABOUT THE COACH <span aria-hidden="true">•</span> <small>International Nurse Preparation Specialist</small></p><h2 id="educator-title">Healthcare English coaching for international nurses.</h2><p>I help international nurses prepare for the English-language demands relevant to the MET, CGFNS, and VisaScreen pathways. We practise patient explanations, clinical scenarios, concise handovers, and the speaking and writing skills needed for the MET.</p><div className="educator-points"><span>✓ CGFNS &amp; VisaScreen pathway context</span><span>✓ Hospital communication practice</span><span>✓ One-on-one feedback and clear next steps</span></div></div></section>
