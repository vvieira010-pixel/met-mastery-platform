        ...
        <div>
          {exercise.imageUrl && (
            <div style={{ marginBottom: 10, textAlign: 'center' }}>
              <img src={exercise.imageUrl} alt={exercise.imageAlt || ''} loading="lazy" style={{ width: '100%', height: 'auto', aspectRatio: '16 / 9', borderRadius: 'var(--radius-sm)', objectFit: 'contain' }} />
            </div>
          )}
      ...
      return (
        <div>
          {(exercise.pictureHint && (/^https?:\/\//.test(exercise.pictureHint) || exercise.pictureHint.startsWith('/'))) ? (
            <div style={{ marginBottom: 10, textAlign: 'center' }}>
              <img src={exercise.pictureHint} alt="Listening context" loading="lazy" style={{ width: '100%', height: 'auto', aspectRatio: '16 / 9', borderRadius: 'var(--radius-sm)', objectFit: 'contain' }} />
            </div>
          ) : null}
          <div style={{
