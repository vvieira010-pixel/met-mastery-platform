...
export function IlloNoClasses() {
  return (
    <IlloWrap label="No classes scheduled">
      <rect x="18" y="12" width="84" height="66" rx="8" stroke="#2D4A4F" strokeWidth="1.5" fill="rgba(45,74,79,0.06)" />
      <rect x="18" y="12" width="84" height="16" rx="8" fill="rgba(45,74,79,0.12)" />
      <rect x="22" y="18" width="20" height="4" rx="2" fill="rgba(45,74,79,0.3)" />
...
export function IlloNoHomework() {
  return (
    <IlloWrap label="No homework assigned">
      <rect x="32" y="10" width="56" height="70" rx="6" stroke="#2D4A4F" strokeWidth="1.5" fill="rgba(45,74,79,0.06)" />
      <rect x="38" y="18" width="18" height="4" rx="2" fill="rgba(45,74,79,0.25)" />
      ...
      <circle cx="48" cy="74" r="3" fill="rgba(45,74,79,0.2)" />
      <circle cx="72" cy="74" r="3" fill="rgba(45,74,79,0.12)" />
    </IlloWrap>
  );
}
...
export function IlloNoStudents() {
  return (
    <IlloWrap label="No students yet">
      <circle cx="44" cy="32" r="12" stroke="#2D4A4F" strokeWidth="1.5" fill="rgba(45,74,79,0.06)" />
      <path d="M32 52c0-6 5.4-11 12-11s12 5 12 11" stroke="#2D4A4F" strokeWidth="1.5" fill="rgba(45,74,79,0.04)" />
      ...
      <path d="M28 62c0-5 4-9 9-9h14c5 0 9 4 9 9" stroke="#4A3D2D" strokeWidth="1.5" fill="rgba(74,61,45,0.05)" strokeLinecap="round" />
    </IlloWrap>
  );
}
