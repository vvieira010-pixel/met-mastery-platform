...
export const Icon = {
  ...
  user:     (p) => <SvgIcon {...p}><path d="M20 21v-2a4 4 0 00-4-4H8a4 4 0 00-4 4v2"/><circle cx="12" cy="7" r="4"/></SvgIcon>,
  users:    (p) => <SvgIcon {...p}><path d="M17 21v-2a4 4 0 00-4-4H5a4 4 0 00-4 4v2"/><circle cx="9" cy="7" r="4"/><path d="M23 21v-2a4 4 0 00-3-3.87"/><path d="M16 3.13a4 4 0 010 7.75"/></SvgIcon>,
  ...
  clock: (p) => <SvgIcon {...p}><circle cx="12" cy="12" r="9"/><polyline points="12 7 12 12 15 14"/></SvgIcon>,
  chat: (p) => <SvgIcon {...p}><path d="M21 11.5a8.38 8.38 0 01-.9 3.8 8.5 8.5 0 01-7.6 4.7 8.38 8.38 0 01-3.8-.9L3 21l1.9-5.7a8.38 8.38 0 01-.9-3.8 8.5 8.5 0 014.7-7.6 8.38 8.38 0 013.8-.9h.5a8.48 8.48 0 018 8v.5z"/></SvgIcon>,
  ...
  chevronUp:    (p) => <SvgIcon d="M18 15l-6-6-6 6" {...p} />,
  dot:          (p) => <SvgIcon {...p}><circle cx="12" cy="12" r="4" fill="currentColor"/></SvgIcon>,
  ...
  moon:     (p) => <SvgIcon {...p}><path d='M21 12.79A9 9 0 1111.21 3 7 7 0 0021 12.79z'/></SvgIcon>,
  ...
  more:     (p) => <SvgIcon {...p}><circle cx="5" cy="12" r="1" fill="currentColor" stroke="none"/><circle cx="12" cy="12" r="1" fill="currentColor" stroke="none"/><circle cx="19" cy="12" r="1" fill="currentColor" stroke="none"/></SvgIcon>,
