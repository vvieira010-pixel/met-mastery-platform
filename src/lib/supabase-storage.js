...
function resolveSupabaseConfig() {
  try {
    ...
    const envKey = import.meta.env.VITE_SUPABASE_ANON_KEY || import.meta.env.VITE_SUPABASE_PUBLISHABLE_KEY || import.meta.env.SUPABASE_PUBLISHABLE_KEY || import.meta.env.SUPABASE_ANON_KEY;
    if (envUrl && envKey) return { url: envUrl, anonKey: envKey, isConfigured: true };
  } catch {}
...
export function getSupabaseConfig() {
  ...
  return {
    ...
    isConfigured: _supabaseConfig.isConfigured,
  };
}
