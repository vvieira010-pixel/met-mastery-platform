...
export {
  ...
  createPracticeStudioSessionKey, createPracticeStudioExerciseKey,
  getPracticeStudioSubmission, getPracticeStudioExerciseSubmissions,
  submitPracticeStudioSession, submitPracticeStudioExercise,
  ...
  getPayments, savePayment, deletePayment, PAYMENT_METHODS,
  syncLocalToCloud, exportStudentData,
